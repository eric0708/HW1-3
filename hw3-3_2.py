...
## fc3 layer ##
W_fc3 = weight_variable([600, 512])
b_fc3 = bias_variable([512])
h_fc3 = tf.nn.relu(tf.matmul(h_fc1, W_fc3) + b_fc3)
W_fc32 = weight_variable([600, 512])
b_fc32 = bias_variable([512])
h_fc32 = tf.nn.relu(tf.matmul(h_fc12, W_fc32) + b_fc32)
W_fc33 = tf.placeholder(tf.float32, [600, 512])
b_fc33 = tf.placeholder(tf.float32, [512])
...
for j in range(4000):
	batch_xs2, batch_ys2 = mnist.train.next_batch(100)
